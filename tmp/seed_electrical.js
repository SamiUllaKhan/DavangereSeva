...
async function seed() {
    try {
        const MONGODB_URI = 'mongodb://localhost:27017/davangere-seva'; // Default, update if needed
        ...
        if (!electricalCategory) {
            ...
            electricalCategory.brandLogos = logoUrls;
            await electricalCategory.save();
            console.log('Updated Electrical Category brands');
        }

        // 2. Clear existing services for this category
